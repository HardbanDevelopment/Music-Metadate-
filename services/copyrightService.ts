...
export const generateCertificate = (metadata: Metadata, hash: string, fileName: string) => {
    ...
    const content = `
===================================================================
                DIGITAL FINGERPRINT CERTIFICATE (PROOF OF EXISTENCE)
===================================================================

This document certifies that on ${date} a digital fingerprint
(SHA-256 Hash) was generated for the audio file.
...
METADATA (AT TIME OF GENERATION):
...
-------------------------------------------------------------------
Generated by Music Metadata Engine
Version: 1.3.0
===================================================================
    `;
