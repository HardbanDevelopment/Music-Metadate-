...
describe('InputSection Component', () => {
    ...
    it('renders upload area correctly', () => {
        ...
        expect(screen.getByText(/Przetwarzanie Wsadowe/i)).toBeDefined();
        expect(screen.getByText(/MP3, WAV, FLAC, M4A/i)).toBeDefined();
    });
    ...
    it('displays batch items when batch is not empty', () => {
        ...
        expect(screen.getByText(/Kolejka/)).toBeDefined();
    ...
    it('disables Analyze button when processing', () => {
        ...
        const analyzeBtn = screen.getByText(/Przetwarzanie.../i);
    ...
    it('calls onAnalyze when button is clicked', () => {
        ...
        const analyzeBtn = screen.getByRole('button', { name: /Analizuj Wsad/i });
