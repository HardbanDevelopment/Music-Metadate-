...
const toneOptions = ["Engaging", "Professional", "Fun", "Poetic"];
  ...
  return (
    <Card>
      <div className="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800 pb-4 mb-4">
        ...
        <div>
          <h3 className="text-lg font-bold text-light-text dark:text-dark-text">Marketing Kit</h3>
          <p className="text-sm text-slate-500 dark:text-slate-400">Generate promotional content.</p>
        </div>
      </div>
      <div className="space-y-3">
        <div className="mb-3">
          <label htmlFor="tone-select" className="block text-xs font-bold uppercase text-slate-500 dark:text-slate-400 tracking-wider mb-2">Communication Tone</label>
          <select
            id="tone-select"
            value={tone}
        ...
        <MarketingButton
          ...
          description="Engaging post for X, Instagram."
        ...
        <MarketingButton
          type="press"
          label="Press Release"
          description="Professional paragraph for media."
        ...
        <MarketingButton
          type="bio"
          label="Streaming Bio"
          description="Catchy bio for Spotify, Apple Music."
