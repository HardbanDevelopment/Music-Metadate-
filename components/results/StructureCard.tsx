    ...
    return (
        <Card>
             <div className="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800 pb-4 mb-4">
                ...
                <div>
                    <h3 className="text-lg font-bold text-light-text dark:text-dark-text">Struktura Utworu</h3>
                    <p className="text-sm text-slate-500 dark:text-slate-400">Analiza sekcji i aranżacji.</p>
                </div>
            </div>
            ...
            {isProcessing ? (
                <div className="flex flex-col items-center justify-center text-center space-y-4 py-8">
                    ...
                    <p className="font-semibold text-light-text dark:text-dark-text">Analizuję strukturę audio...</p>
                </div>
                ...
                <div className="animate-fade-in">
                    ...
                    <div className="mt-4 space-y-2 max-h-60 overflow-y-auto pr-2 custom-scrollbar">
                     ...
                     <Button onClick={onAnalyze} variant="secondary" size="sm" className="mt-4 w-full">
                        <Sparkles className="w-4 h-4" /> Przeanalizuj ponownie
                    </Button>
                </div>
            ) : (
                <div className="text-center p-4">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">
                        Automatycznie wykryj sekcje utworu (Intro, Zwrotka, Refren) i ich ramy czasowe.
                    </p>
                    <Button onClick={onAnalyze} variant="primary" size="sm" className="w-auto mx-auto hover:scale-105 transition-transform">
                        <Sparkles className="w-5 h-5" /> Analizuj Strukturę
                    </Button>
                </div>
            )}
        </Card>
