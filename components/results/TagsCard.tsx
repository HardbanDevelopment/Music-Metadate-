    ...
    return (
        <Card>
            <div className="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800 pb-4 mb-4">
                ...
                <div>
                    <h3 className="text-lg font-bold text-light-text dark:text-dark-text">Tags & Classification</h3>
                    <p className="text-sm text-slate-500 dark:text-slate-400">Genres, keywords, and context.</p>
                </div>
            </div>
            ...
            <div className="space-y-6">
                ...
                <div className="bg-pink-50 dark:bg-pink-900/10 p-3 rounded-lg border border-pink-100 dark:border-pink-900/30">
                    <div className="flex justify-between items-center mb-2">
                        <h4 className="text-xs font-bold text-pink-600 dark:text-pink-400 uppercase tracking-wider">Main Genre</h4>
                        <Tooltip text="Suggest precise main genre (AI)">
                ...
                <div>
                    <div className="flex justify-between items-center mb-2">
                        <h4 className="text-xs font-bold text-slate-500 uppercase tracking-wider">Additional Genres</h4>
                        <Tooltip text="Suggest subgenres (AI)">
                ...
                <div className="border-t border-slate-200 dark:border-slate-800 pt-4 space-y-4">
                    <TagSection title="Keywords" field="keywords" tags={metadata.keywords} {...{ isEditing, onFieldUpdate, refiningField, onRefine }} />
                    {metadata.moods && <TagSection title="Moods" field="moods" tags={metadata.moods} {...{ isEditing, onFieldUpdate, refiningField, onRefine }} />}
                </div>
            </div>
        </Card>
    );
