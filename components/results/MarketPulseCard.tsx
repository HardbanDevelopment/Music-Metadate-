  ...
  return (
    <Card>
      <div className="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800 pb-4 mb-4">
        ...
        <div>
          <h3 className="text-lg font-bold text-light-text dark:text-dark-text">Market Pulse</h3>
          <p className="text-sm text-slate-500 dark:text-slate-400">Trend and popularity analysis.</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {!marketPulseData && !isFetching && !error && (
          <div className="text-center p-4">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-2 mb-4">
              Discover trends, artists, and playlists matching your music based on current data.
            </p>
        ...
        {isFetching && (
          <div className="flex flex-col items-center justify-center text-center space-y-4 py-10">
            ...
            <p className="font-semibold text-light-text dark:text-dark-text">Analyzing market data...</p>
          </div>
        )}
        {error && (
        ...
        {marketPulseData && (
          <div className="animate-fade-in space-y-4">
            <div className="flow-root">
              <h4 className="font-bold text-sm mb-1">Similar Tracks</h4>
            ...
            <div className="flow-root">
              <h4 className="font-bold text-sm mb-1">Popular Artists</h4>
              <ul role="list" className="-my-2 divide-y divide-slate-200 dark:divide-slate-700">
                {marketPulseData.artists?.map((artist, i) => <ResultItem key={`artist-${i}`} item={artist} type="artist" />)}
              </ul>
            </div>
            <div className="flow-root">
              <h4 className="font-bold text-sm mb-1">Influential Playlists</h4>
              <ul role="list" className="-my-2 divide-y divide-slate-200 dark:divide-slate-700">
