            ...
            >
                ...
                <div className="p-6 overflow-y-auto text-slate-600 dark:text-slate-300 space-y-4 flex-grow">
                    {activeTab === 'about' ? (
                        <>
                            <p>
                                <strong>Music Metadata Engine</strong> is a modern tool for producers, DJs and creators, automating the tedious music cataloging process using AI.
                            </p>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-4">
                                <div className="p-4 bg-slate-100 dark:bg-slate-800/50 rounded-lg">
                                    ...
                                    <p className="text-sm">Automatic BPM, key and genres. Generate descriptions, social media posts and promotional videos.</p>
                                </div>
                                <div className="p-4 bg-slate-100 dark:bg-slate-800/50 rounded-lg">
                            ...
                            <p className="text-sm italic text-slate-500">
                                Demo version application (Client-Side). Requires your own API key for some features.
                            </p>
                        </>
                    ) : (
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <StatusItem label="User Account System (Auth)" status="pending" />
                            ...
                            <div>
                                ...
                                <ol className="relative border-l border-slate-200 dark:border-slate-700 ml-3 space-y-6">
                                    ...
                                    <li className="mb-2 ml-6">
                                        ...
                                        <h3 className="font-medium leading-tight text-light-text dark:text-dark-text">Phase 2: Infrastructure (Q3 2024)</h3>
                                        <p className="text-sm text-slate-500">Firebase/Supabase deployment, secure API Proxy, user accounts.</p>
                                    </li>
                                    <li className="mb-2 ml-6">
                                        <span className="absolute flex items-center justify-center w-6 h-6 bg-slate-200 rounded-full -left-3 ring-4 ring-white dark:ring-slate-900 dark:bg-slate-700">
                                            <span className="text-xs font-bold text-slate-600 dark:text-slate-300">3</span>
                                        </span>
                                        <h3 className="font-medium leading-tight text-light-text dark:text-dark-text">Phase 3: Commercialization (Q4 2024)</h3>
