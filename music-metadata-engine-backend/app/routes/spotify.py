...
async def search_spotify(query: SpotifySearchQuery, token: str = Depends(get_spotify_access_token)):
    """
...
async def get_audio_features(track_id: str, token: str = Depends(get_spotify_access_token)):
    """
